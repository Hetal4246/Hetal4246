<h1 align="center">Hi 👋, I'm Hetal Vaghela</h1>
<h3 align="center">Data Engineer · Boston, MA</h3>

<br/>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=15&duration=3000&pause=1000&color=1D9E75&center=true&vCenter=true&width=500&lines=Real-Time+Streaming+%7C+Cloud+Pipelines;Snowflake+%7C+dbt+%7C+Apache+Kafka;AWS+%7C+Databricks+%7C+Apache+Spark;Healthcare+%26+Financial+Data+Engineering" alt="Typing SVG" />
</p>

<br/>

- 🔭 &nbsp; I'm currently working as a **Data Engineer** building real-time data pipelines
...
```
                    ┌─────────────────────────────────────┐
                    │           DATA SOURCES               │
                    │  DBs · APIs · EHR · POS · Streams   │
                    └──────────────┬──────────────────────┘
                                   │
                    ┌──────────────▼──────────────────────┐
                    │            INGESTION                 │
                    │   Kafka · Auto Loader · GoldenGate  │
                    │        REST APIs · JDBC              │
                    └──────────────┬──────────────────────┘
                                   │
               ┌───────────────────┼───────────────────┐
   ...
   │  Raw · Unmodified│ │  Cleaned · DLT  │ │  dbt · Metrics   │
   │  Delta Lake · S3 │ │  Validated      │ │  Business Ready  │
   └──────────────────┘ └─────────────────┘ └────────┬─────────┘
                                                      │
                    ┌─────────────────────────────────▼───────────┐
                    │               PROCESSING                     │
                    │      Spark · PySpark · Python · SQL          │
                    │   Streaming (30s) · Batch · ML Pipelines     │
                    └─────────────────────────────────┬───────────┘
                                                      │
                    ┌─────────────────────────────────▼───────────┐
                    │                STORAGE                       │
                    │     Snowflake · Delta Lake · S3 · BigQuery   │
                    │       ACID · Time-Travel · Partitioned        │
                    └─────────────────────────────────┬───────────┘
                                                      │
               ┌──────────────────┬───────────────────┼──────────────────┐
               │                  │                   │                  │
   ┌───────────▼──────┐ ┌─────────▼───────┐ ┌────────▼───────┐ ┌────────▼───────┐
   │   BI & REPORTS   │ │   ML PLATFORM   │ │  DATA QUALITY  │ │   GOVERNANCE   │
   │ Tableau · Power  │ │ TensorFlow      │ │ dbt Tests      │ │ Unity Catalog  │
   │ BI · QuickSight  │ │ XGBoost · SHAP  │ │ 680+ Checks    │ │ HIPAA · KMS    │
   └──────────────────┘ └─────────────────┘ └────────────────┘ └────────────────┘
```
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=hetal4246&color=1D9E75&style=flat-square&label=Profile+Views" />
</p>
